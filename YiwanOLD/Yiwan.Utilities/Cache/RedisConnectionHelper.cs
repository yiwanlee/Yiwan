...
namespace Yiwan.Utilities.Cache
{
    ...
    public static class RedisConnectionHelper
    {
        ...
        public static string PrefixKey; // 自定义Key的前缀，每个Key都会自动增加此前缀
        ...
        public static ConnectionMultiplexer Instance
        {
            get
            {
                if (string.IsNullOrWhiteSpace(RedisConnectionString)) throw new ArgumentException("RedisHosts为null，请执行Initialize初始化");
