...
using System.Linq;
using System.Text;
using Yiwan.Helpers.Http.Base;
using System.Drawing;
using System.IO;
using Yiwan.Helpers.Http.Enum;
using Yiwan.Helpers.Http.Helper;

namespace Yiwan.Helpers.Http.BaseBll
{
    /// <summary>
    ...
    internal class HttpHelperBll
    {
        ...
        /// Httphelper原始访问类对象
        /// </summary>
        private readonly HttphelperBase httpbase = new HttphelperBase();
        /// <summary>
        /// 根据相传入的数据，得到相应页面数据
        /// </summary>
        ...
        internal Image GetImage(HttpItem item)
        {
            ...
            return ImageHelper.ByteToImage(GetHtml(item).GetResultByte());
        }
        /// <summary>
