...
namespace Yiwan.Helpers.Http.Helper
{
    ...
    internal class ExecJsHelper
    {
        ...
        internal static string JavaScriptEval(string strJs, string main)
        {
            ...
            //执行JS
            return type.InvokeMember("Eval", BindingFlags.InvokeMethod, null, obj, new object[] { main }, CultureInfo.InvariantCulture).ToString();
        }
        #endregion
        ...
        {
            //设置语言类型
            type.InvokeMember("Language", BindingFlags.SetProperty, null, obj, new object[] { "JScript" }, CultureInfo.InvariantCulture);
            //添加JS代码
            type.InvokeMember("AddCode", BindingFlags.InvokeMethod, null, obj, new object[] { strJs }, CultureInfo.InvariantCulture);
            return type;
        }
        /// <summary>
        /// 获取ScriptControl接口对象
