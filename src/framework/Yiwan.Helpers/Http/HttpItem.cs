...
namespace Yiwan.Helpers.Http
{
    ...
    public class HttpItem
    {
        ...
        private byte[] postdataByte;
        /// <summary>
        /// 获取Post请求时要发送的Byte类型的Post数据
        /// </summary>
        public byte[] GetPostdataByte() { return (byte[])postdataByte.Clone(); }
        /// <summary>
        /// 设置Post请求时要发送的Byte类型的Post数据
        /// </summary>
        public void SetPostdataByte(byte[] postData)
        {
            if (postData == null) postdataByte = Array.Empty<byte>();
            else postdataByte = (byte[])postData.Clone();
        }
        #endregion
        ...
        /// 设置509证书集合
        /// </summary>
        public X509CertificateCollection ClentCertificates { get; private set; }
        public void SetClentCertificates(X509CertificateCollection x509c)
        {
            ClentCertificates = new X509CertificateCollection();
            if (x509c != null) ClentCertificates.AddRange(x509c);
        }
