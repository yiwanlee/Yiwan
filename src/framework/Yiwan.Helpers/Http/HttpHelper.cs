...
using System.Text;
using System.Net;
using Yiwan.Helpers.Http.BaseBll;
...
namespace Yiwan.Helpers.Http
{
    ...
    public class HttpHelper
    {
        ...
        public static object JsonToObject<T>(string value)
        {
        ...
        {
            return Utilities.JsonUtility.ConvertToJson(value);
        }
        #endregion
